...
namespace RetroScrap2000
{
  ...
  public partial class FormMain : Form
  {
    ...
    private void UpdateContextMenuMediaItemsVisibility(GameEntry? rom)
    {
      ...
      foreach (var kvp in rom!.MediaTypeDictionary)
      {
        ...
        // Nur wenn der Pfad nicht vorhanden (nicht null, nicht leer) ist, einen Neu-Eintrag freischalten
    ...
    private async Task UpdateMediaPanelAsync(GameEntry? rom, string baseDir, CancellationToken ct)
    {
      ...
      UpdateContextMenuMediaItemsVisibility(rom);
    ...
    private void contextMenuStripMedia_Opened(object sender, EventArgs e)
    {
      var menuItem = sender as ContextMenuStrip;
      if (menuItem == null) return;
      bool visbleMediaPrevieControls = menuItem.SourceControl is MediaPreviewControl;
      MediaviewToolStripMenuItem.Visible = visbleMediaPrevieControls;
      MedianewToolStripMenuItem.Visible = visbleMediaPrevieControls;
      MediadeleteToolStripMenuItem.Visible = visbleMediaPrevieControls;
      MediatoolStripSeparator.Visible = visbleMediaPrevieControls;
      UpdateContextMenuMediaItemsVisibility(_selectedRoms != null && _selectedRoms.Count == 1 ? _selectedRoms[0] : null);
    }
